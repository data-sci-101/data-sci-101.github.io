...
webr:
  ...
  packages: ['tidyverse', 'scales', 'DT', 'unvotes']
filters:
  - webr
---
...
1.  David Robinson (2021). [unvotes](https://CRAN.R-project.org/package=unvotes): United Nations General Assembly Voting Data. R package version 0.3.0.

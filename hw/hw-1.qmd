...
-   Go to the [data-sci-101](https://github.com/data-sci-101) organization on GitHub.
    Click on the repo with the prefix `hw-1`.
    It contains the starter documents you need to complete the homework assignment.

-   Go to Posit Cloud and click on New Project \> New RStudio Project from Git.
    Make sure you've connected your Posit Cloud and GitHub accounts.
